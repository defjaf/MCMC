...
cccc g77 -o likoctsub likoctsub.for -L/home/jaffe/local/lib/Linux_Xeon_gcc32_2/ -llapack -lf77blas -lcblas -latlas
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c      print*,hub,alikelihood(1.d0,hub,alpha,beta,gamma)
c      enddo 

c      call likelihood(1.d0,64.d0,0.,0.,0.,alikelihood)
c      print*,alikelihood
      do i=1,21
         alpha=2.*acos(-1.)/float(20)*(i-1)
         call likelihood(1.d0,64.d0,alpha,0.,0.,alikelihood)
         print*,alpha,alikelihood
      enddo
...
c      print*,kwav(i),mult(i)
      ...
      do i=1,kvalnum
         ...
         enddo
      enddo
      open(8,file='BinaryOctahedral-8orth.dat')
         do j=1,mult(1)
            do k=1,(kwav(1)+1)**2
...
c      print*,kwav(1),xi(1,mult(1),(kwav(1)+1)**2)
      open(9,file='BinaryOctahedral-12orth.dat')
         do j=1,mult(2)
            do k=1,(kwav(2)+1)**2
...
c      print*,kwav(2),xi(2,mult(2),(kwav(2)+1)**2)
      open(10,file='BinaryOctahedral-16orth.dat')
         do j=1,mult(3)
            do k=1,(kwav(3)+1)**2
...
c      print*,kwav(3),xi(3,mult(3),(kwav(3)+1)**2)
      open(11,file='BinaryOctahedral-18orth.dat')
         do j=1,mult(4)
            do k=1,(kwav(4)+1)**2
...
c      print*,kwav(4),xi(4,mult(4),(kwav(4)+1)**2)
      open(12,file='BinaryOctahedral-20orth.dat')
         do j=1,mult(5)
            do k=1,(kwav(5)+1)**2
...
c      print*,kwav(5),xi(5,mult(5),(kwav(5)+1)**2)
      open(13,file='BinaryOctahedral-24orth.dat')
         do j=1,mult(6)
            do k=1,(kwav(6)+1)**2
...
c      print*,kwav(6),xi(6,mult(6),(kwav(6)+1)**2)
      open(14,file='BinaryOctahedral-26orth.dat')
         do j=1,mult(7)
            do k=1,(kwav(7)+1)**2
...
c      print*,kwav(7),xi(7,mult(7),(kwav(7)+1)**2)
      open(15,file='BinaryOctahedral-28orth.dat')
         do j=1,mult(8)
            do k=1,(kwav(8)+1)**2
...
c      print*,kwav(8),xi(8,mult(8),(kwav(8)+1)**2)
      open(16,file='BinaryOctahedral-30orth.dat')
         do j=1,mult(9)
            do k=1,(kwav(9)+1)**2
...
c      print*,kwav(9),xi(9,mult(9),(kwav(9)+1)**2)
      open(17,file='BinaryOctahedral-32orth.dat')
         do j=1,mult(10)
            do k=1,(kwav(10)+1)**2
...
c      print*,kwav(10),xi(10,mult(10),(kwav(10)+1)**2)
      open(18,file='BinaryOctahedral-34orth.dat')
         do j=1,mult(11)
            do k=1,(kwav(11)+1)**2
...
c      print*,kwav(11),xi(11,mult(11),(kwav(11)+1)**2)
      open(19,file='BinaryOctahedral-36orth.dat')
         do j=1,mult(12)
            do k=1,(kwav(12)+1)**2
...
c      print*,kwav(12),xi(12,mult(12),(kwav(12)+1)**2)
      open(20,file='BinaryOctahedral-38orth.dat')
         do j=1,mult(13)
            do k=1,(kwav(13)+1)**2
...
c      print*,kwav(13),xi(13,mult(13),(kwav(13)+1)**2)
      open(21,file='BinaryOctahedral-40orth.dat')
         do j=1,mult(14)
            do k=1,(kwav(14)+1)**2
