...
c      enddo 
      do i=1,21
         ...
         print*,gamma,alikelihood(1.d0,64.d0,0.,0.,gamma)
      enddo
...
c      print*,kwav(i),mult(i)
      ...
      enddo
      open(8,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-6orth.dat')
         do j=1,mult(1)
            do k=1,(kwav(1)+1)**2
       ...
       close(8)
      open(9,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-8orth.dat')
         do j=1,mult(2)
            do k=1,(kwav(2)+1)**2
       ...
       close(9)
      open(10,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-12orth.dat')
         do j=1,mult(3)
            do k=1,(kwav(3)+1)**2
       ...
       close(10)
      open(11,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-14orth.dat')
         do j=1,mult(4)
            do k=1,(kwav(4)+1)**2
       ...
       close(11)
      open(12,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-16orth.dat')
         do j=1,mult(5)
            do k=1,(kwav(5)+1)**2
       ...
       close(12)
      open(13,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-18orth.dat')
         do j=1,mult(6)
            do k=1,(kwav(6)+1)**2
       ...
       close(13)
      open(14,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-20orth.dat')
         do j=1,mult(7)
            do k=1,(kwav(7)+1)**2
       ...
       close(14)
      open(15,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-22orth.dat')
         do j=1,mult(8)
            do k=1,(kwav(8)+1)**2
       ...
       close(15)
      open(16,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-24orth.dat')
         do j=1,mult(9)
            do k=1,(kwav(9)+1)**2
       ...
       close(16)
      open(17,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-26orth.dat')
         do j=1,mult(10)
            do k=1,(kwav(10)+1)**2
       ...
       close(17)
      open(18,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-28orth.dat')
         do j=1,mult(11)
            do k=1,(kwav(11)+1)**2
       ...
       close(18)
      open(19,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-30orth.dat')
         do j=1,mult(12)
            do k=1,(kwav(12)+1)**2
       ...
       close(19)
      open(20,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-32orth.dat')
         do j=1,mult(13)
            do k=1,(kwav(13)+1)**2
       ...
       close(20)
      open(21,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-34orth.dat')
         do j=1,mult(14)
            do k=1,(kwav(14)+1)**2
       ...
       close(21)
      open(22,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-36orth.dat')
         do j=1,mult(15)
            do k=1,(kwav(15)+1)**2
       ...
       close(22)
      open(23,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-38orth.dat')
         do j=1,mult(16)
            do k=1,(kwav(16)+1)**2
       ...
       close(23)
      open(24,file=
     *datdir(1:lnblnk(datdir))//'BinaryTetrahedral-40orth.dat')
         do j=1,mult(17)
            do k=1,(kwav(17)+1)**2
...
c                  print*,hubble(i)
     ...
     *                       fail)
                 if (fail) then
                    print *, 'Failure in ratint (1); h0=',h0
                    alikelihood = 0.0
                    return
                 endif
     ...
     *                       fail)
                 if (fail) then
                    print *, 'Failure in ratint (2); h0=',h0
                    alikelihood = 0.0
                    return
                 endif
