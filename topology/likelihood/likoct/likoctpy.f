...
c      print*,kwav(i),mult(i)
      ...
      enddo
      open(28,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-8orth.dat')
         do j=1,mult(1)
            do k=1,(kwav(1)+1)**2
       ...
       close(28)
      open(29,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-12orth.dat')
         do j=1,mult(2)
            do k=1,(kwav(2)+1)**2
       ...
       close(29)
      open(10,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-16orth.dat')
         do j=1,mult(3)
            do k=1,(kwav(3)+1)**2
       ...
       close(10)
      open(11,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-18orth.dat')
         do j=1,mult(4)
            do k=1,(kwav(4)+1)**2
       ...
       close(11)
      open(12,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-20orth.dat')
         do j=1,mult(5)
            do k=1,(kwav(5)+1)**2
       ...
       close(12)
      open(13,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-24orth.dat')
         do j=1,mult(6)
            do k=1,(kwav(6)+1)**2
       ...
       close(13)
      open(14,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-26orth.dat')
         do j=1,mult(7)
            do k=1,(kwav(7)+1)**2
       ...
       close(14)
      open(15,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-28orth.dat')
         do j=1,mult(8)
            do k=1,(kwav(8)+1)**2
       ...
       close(15)
      open(16,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-30orth.dat')
         do j=1,mult(9)
            do k=1,(kwav(9)+1)**2
       ...
       close(16)
      open(17,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-32orth.dat')
         do j=1,mult(10)
            do k=1,(kwav(10)+1)**2
       ...
       close(17)
      open(18,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-34orth.dat')
         do j=1,mult(11)
            do k=1,(kwav(11)+1)**2
       ...
       close(18)
      open(19,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-36orth.dat')
         do j=1,mult(12)
            do k=1,(kwav(12)+1)**2
       ...
       close(19)
      open(20,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-38orth.dat')
         do j=1,mult(13)
            do k=1,(kwav(13)+1)**2
       ...
       close(20)
      open(21,
     *file=datdir(1:len_trim(datdir))//'BinaryOctahedral-40orth.dat')
         do j=1,mult(14)
            do k=1,(kwav(14)+1)**2
