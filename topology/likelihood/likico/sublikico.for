...
cccc g77 -o sublikico sublikico.for -L/home/jaffe/local/lib/Linux_Xeon_gcc32_2/ -llapack -lf77blas -lcblas -latlas
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c      hub=(70.d0-52.d0)/dble(20)*(i-1)+52.d0
      call likelihood(1.d0,64.d0,alpha,beta,gamma,alikelihood)
c      print*,hub,alikelihood,dlog(alikelihood)
c      print*,alpha,dlog(alikelihood)
      enddo 
...
c       enddo
c       close(12)
c       print*,clm(7,7),clm(8,8),clm(9,9),clm(10,10)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c       print*,clm(7,7),clm(8,8),clm(9,9),clm(10,10)
       ...
       do i=1,117                                       !of clm. Therefore the determinant is
          dlogdet=dlogdet+dlog(abs(clm(i,i)))           !the product of the diagonal elements of the
       enddo                                            !matrix containing the LU factors
       dlogdet=dlogdet+dlog(2.d0*dacos(-1.d0))
c       print*,dlogdet,exp(dlogdet)
...
ccccc  compute -1/2*Conjugate(alm)*inv(C_lml'm')*alm ccccccccccccccccccccccccc
       ...
       enddo
c       print*,sumlik
       alik1=-1.d0/2.d0*dreal(sumlik)    ! the exponential
       print*,alik1
       alik1=alik1-1.d0/2.d0*dlogdet     ! add Log(1/sqrt(2pi*det[C_lml'm']))
c       print*,alik1
       alikelihood=exp(alik1)
c       print*,flik
       return
       end
