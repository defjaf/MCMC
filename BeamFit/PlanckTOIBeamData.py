...
def read_data_Planck_TOI(files=None, sigcut=0.0, ctscut=0, nhits=None, neg=False, noise=None, mapsize=0.01, **kwargs):
    """
    
    read TOI data. 

    OLD -- still does this, not yet modified: 
    For each detector, read a pair (data, nhit).
            ...
            for obj in objs:
                for it in iters:
                    for MC in MCs:
                        ...
                        data, xyrange = read_data_Planck_PIO(det=det, MC=MC, iter=it, obj=obj, 
